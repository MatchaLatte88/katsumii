  ...
  return [
    {
      ...
      seats: '1',
      seatsLabel: 'sample account',
      entries: '5',
      entriesLabel: 'sample trades included',
      inclusionLabel: null,
    },
    {
      key: 'professional',
      ...
      displayFeatures: t2.features.slice(1), // skip "Everything in Standard" — conveyed by divider label
      cta: t2.cta,
      ctaHref: baseUrl,
      highlighted: true,
      ...
      seats: 'Unlimited',
      seatsLabel: 'accounts (incl. prop)',
      entries: 'Unlimited',
      entriesLabel: 'trade entries',
      inclusionLabel: 'LIGHT +',
    },
    {
      key: 'light',
      name: t1.name,
